...
class MT5Attention(nn.Module):
    ...
    def forward(
        ...
        if self.retain_gradients:
            self.multihead_output = attn_output
...
class MT5Stack(MT5PreTrainedModel):
    ...
    def forward(
        ...
        # if self.retain_gradients:
        #     self.stack_output = hidden_states
        #     self.stack_output.retain_grad()
...
class MT5ForConditionalGeneration(MT5PreTrainedModel):
    ...
    def _get_model_outputs(self, key):
        ...
        # elif key == "decoder_stack_output":
        #     return self.decoder.stack_output
        else:
